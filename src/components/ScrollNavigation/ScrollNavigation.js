...
class ScrollNavigation extends Component {
  ...
  scrollHandler = () => {
    ...
    this.scrollTimer = setTimeout(() => {
      ...
      for (const heading of this.state.headings) {
        if (document.getElementById(heading.id).offsetTop >= scrollThreshold) {
          break
        }
        last = heading
      }
  ...
  render() {
    ...
    return (
      <Element className="scroll-navigation-container-sticky">
        <Element className="scroll-navigation-container-center">
          <Element
            tag="ul"
            dirColumn
